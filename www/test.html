...
<script data-rocketsrc="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/rocketscript"></script>
<script data-rocketsrc="modernizr.js" type="text/rocketscript"></script>
...
<hr>
<div class="content used-by promo">
<h2>As used by&hellip;</h2>
<a href="http://ghostgames.com"><img class="co-logo" src="images/ea-logo.png" height="50" alt="EA Games Logo" title="EA Games"></a>
<a href="http://foursquare.com"><img class="co-logo" src="images/foursquare-logo.png" height="50" alt="Foursquare Logo" title="Foursquare"></a>
<a href="http://hipstamatic.com"><img class="co-logo" src="images/hipstamatic-logo.png" height="50" alt="Hipstamatic Logo" title="Hipstamatic"></a>
</div>
<footer>
<p class="cf">A thing made by <a href="http://twitter.com/_dte">Dan Eden</a> <span class="alignright"><a href="https://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-via="_dte">Tweet</a><script type="text/rocketscript" data-rocketsrc="//platform.twitter.com/widgets.js"></script></span></p>
</footer>
</div>
<script type="text/rocketscript">
	function testAnim(x) {
